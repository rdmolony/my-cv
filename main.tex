...
\usepackage[left=1cm, right=1cm, bottom=2cm, top=2cm]{geometry} % for adding a page margin
...
\cventry
  ...
  {
    \item 
    I graduated my Bachelor's degree with 1st class honours (gold medal). The degree remained multidisciplinary for two years, which exposed
